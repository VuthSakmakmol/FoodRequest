...
const rows      = ref([])
const search    = ref('')
const statusTab = ref('PENDING_GM')
      ...
      <v-col cols="12" class="d-flex flex-column flex-md-row align-md-center justify-md-space-between">
        <div class="mb-3 mb-md-0">
          ...
          <p class="text-body-2 text-medium-emphasis">
            Review and finalize expatriate leave requests escalated to GM.
          </p>
        </div>
    ...
    <v-row>
      <v-col cols="12">
        <v-tabs
          ...
          class="mb-2"
        >
          <v-tab value="PENDING_GM">Pending (GM)</v-tab>
          ...
          <v-card-text class="pa-0">
            ...
            >
              ...
              <template #item.actions="{ item }">
                <template v-if="item.status === 'PENDING_GM'">
                  <v-btn
                    size="small"
                    color="green"
                    variant="tonal"
