...
const appTitle = 'Trax — Chef'

/** Sections (Chef manages Food only; no Transportation, no Dashboard) */
const sections = [
  {
    key: 'food',
    header: 'Food Request',
...
function logout() {
  ...
  router.push({ name: '/' }) // redirect to chef login
}

</script>

<template>
  <div class="chef-theme">
    <v-app>
      <!-- TOP BAR -->
