...
/* Fill form fields from directory */
...
/* Sync when parent sets employeeId (e.g. from localStorage) */
watch(
...
<template>
  ...
  >
    <!-- Gradient header (same look as before) -->
    <header
    ...
    <!-- Body wrapper + inner card (same card style family as other sections) -->
    <div
      class="rounded-b-2xl bg-slate-50/80 p-3
    ...
    >
      ...
      >
        <div class="space-y-4 text-xs text-slate-800 dark:text-slate-100">
          <!-- Search / filter Autocomplete -->
          <div ref="rootEl" class="relative">
            <label
              class="mb-1 block text-[11px] font-semibold text-slate-700 dark:text-slate-100"
            >
              Employee
          ...
          <div class="gap-3">
            ...
            <div>
              <label
                class="flex items-center text-[11px] mt-2 font-semibold text-slate-700 dark:text-slate-100"
              >
