...
const groups = [
  {
    ...
    children: [
      ...
      { label: 'Calendar', icon: 'fa-regular fa-calendar-days', to: { name: 'admin-food-calendar' } },
    ],
  },
  {
    key: 'transport',
    ...
    children: [
      { label: 'Car Booking', icon: 'fa-solid fa-car-on', to: { name: 'admin-car-booking' } },
      { label: 'Calendar',    icon: 'fa-regular fa-clock', to: { name: 'admin-car-calendar' } },
    ],
  },
]
...
const appTitle = computed(() => route.meta?.title || 'Admin Panel')
      ...
      >
        ...
        >
          <div class="truncate font-semibold">
            {{ auth.user?.name || auth.user?.loginId || 'Admin' }}
          </div>
