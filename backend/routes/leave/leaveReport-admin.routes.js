...
// ✅ one guard for this router
router.use(auth.requireAuth)
router.use(auth.requireRole('LEAVE_ADMIN', 'ADMIN', 'ROOT_ADMIN'))

// Summary report
router.get('/admin/leave/reports/summary', leaveReportCtrl.getLeaveReportSummary)

// Per employee printable record
router.get('/admin/leave/reports/employee/:employeeId/record', leaveRecordCtrl.getEmployeeLeaveRecord)
